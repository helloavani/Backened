...
FooterComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        template: "\n    <span class=\"created-by\">Created with \u2665 by <b><a href=\"https://facebook.com/bhuvangahlot\" target=\"_blank\">Here U Go</a></b> 2017</span>\n    <div class=\"socials\">\n      <a href=\"#\" target=\"_blank\" class=\"ion ion-social-github\"></a>\n      <a href=\"#\" target=\"_blank\" class=\"ion ion-social-facebook\"></a>\n      <a href=\"#\" target=\"_blank\" class=\"ion ion-social-twitter\"></a>\n      <a href=\"#\" target=\"_blank\" class=\"ion ion-social-linkedin\"></a>\n    </div>\n  ",
    })
], FooterComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__nebular_auth__ = __webpack_require__("../../../../@nebular/auth/index.js");
...
var HeaderComponent = (function () {
    function HeaderComponent(authService, sidebarService, menuService, userService, analyticsService, apicall) {
        var _this = this;
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.apicall.getUser()
            ...
            _this.user = res.firstname + " " + res.lastname;
...
HeaderComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__nebular_auth__["e" /* NbAuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__nebular_auth__["e" /* NbAuthService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__nebular_theme__["k" /* NbSidebarService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__nebular_theme__["k" /* NbSidebarService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__nebular_theme__["g" /* NbMenuService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__nebular_theme__["g" /* NbMenuService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__core_data_users_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__core_data_users_service__["a" /* UserService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__core_utils_analytics_service__["a" /* AnalyticsService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__core_utils_analytics_service__["a" /* AnalyticsService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_5__providers_apicall_apicall__["a" /* ApicallProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__providers_apicall_apicall__["a" /* ApicallProvider */]) === "function" && _f || Object])
], HeaderComponent);
...
var routes = [
        ...
        loadChildren: 'app/pages/pages.module#PagesModule' },
    {
        ...
        children: [
            {
                path: '',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["g" /* NbLoginComponent */],
            },
            {
                path: 'login',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["g" /* NbLoginComponent */],
            ...
            {
                path: 'register',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["i" /* NbRegisterComponent */],
            },
            {
                path: 'logout',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["h" /* NbLogoutComponent */],
            },
            {
                path: 'request-password',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["j" /* NbRequestPasswordComponent */],
            },
            {
                path: 'reset-password',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["k" /* NbResetPasswordComponent */],
            },
        ],
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__nebular_auth__ = __webpack_require__("../../../../@nebular/auth/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_apicall_apicall__ = __webpack_require__("../../../../../src/app/providers/apicall/apicall.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
        ...
        providers: [
            ...
            { provide: __WEBPACK_IMPORTED_MODULE_6__nebular_auth__["a" /* NB_AUTH_TOKEN_WRAPPER_TOKEN */], useClass: __WEBPACK_IMPORTED_MODULE_6__nebular_auth__["c" /* NbAuthJWTToken */] },
            __WEBPACK_IMPORTED_MODULE_11__auth_guard_service__["a" /* AuthGuard */],
            __WEBPACK_IMPORTED_MODULE_12__providers_apicall_apicall__["a" /* ApicallProvider */],
        ],
    })
], AppModule);
...
AuthGuard = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["e" /* NbAuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["e" /* NbAuthService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _b || Object])
], AuthGuard);
...
/***/ "../../../../../src/app/providers/apicall/apicall.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ApicallProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
var apiUrl = 'http://18.222.10.176:3000/api/v1/';
...
/*
  ...
  and Angular DI.
*/
var ApicallProvider = (function () {
    function ApicallProvider(http) {
        this.http = http;
        console.log('Hello ApicallProvider Provider');
    }
    ApicallProvider.prototype.getdevicelist = function () {
        var _this = this;
        ...
        return this.http.get(apiUrl + 'getalldevices', { headers: headers })
            .map(function (result) { return _this.result = result.json().DeviceList; });
    };
    ApicallProvider.prototype.deletecat = function (id) {
        console.log(id);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'deletecat', { id: id }, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.deleteorder = function (id) {
        console.log(id);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'deleteorder', { id: id }, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.deletebrand = function (id) {
        console.log(id);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'deletebrand', { id: id }, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.deleteproduct = function (id) {
        console.log(id);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'deleteproduct', { id: id }, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.deleteuser = function (id) {
        console.log(id);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'deleteuser', { id: id }, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.getallproducts = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.get(apiUrl + 'getallproducts', { headers: headers })
            .map(function (result) { return _this.result = result.json().ProductList; });
    };
    ApicallProvider.prototype.editproduct = function (newData) {
        console.log(newData);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'editproduct', newData, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.getallcat = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.get(apiUrl + 'getallcat', { headers: headers })
            .map(function (result) { return _this.result = result.json().CategoryList; });
    };
    ApicallProvider.prototype.edituser = function (newData) {
        console.log(newData);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'edituser', newData, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.editcategory = function (newData) {
        console.log(newData);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'editcategory', newData, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.editbrand = function (newData) {
        console.log(newData);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'editbrand', newData, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.editorder = function (newData) {
        console.log(newData);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'editorder', newData, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.getallbrands = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.get(apiUrl + 'getallbrands', { headers: headers })
            .map(function (result) { return _this.result = result.json().BrandList; });
    };
    ApicallProvider.prototype.getallusers = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.get(apiUrl + 'getallusers', { headers: headers })
            .map(function (result) { return _this.result = result.json().UserList; });
    };
    ApicallProvider.prototype.getallvendors = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
    ...
    ApicallProvider.prototype.addNewUser = function (user) {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
    ...
    ApicallProvider.prototype.addNewDevice = function (device) {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
    ...
    ApicallProvider.prototype.addNewProduct = function (device) {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
    ...
    ApicallProvider.prototype.placeorder = function (device) {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
    ...
    ApicallProvider.prototype.getallorders = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.get(apiUrl + 'getallorders', { headers: headers })
            .map(function (result) { return _this.result = result.json().OrderList; });
    };
    ApicallProvider.prototype.addNewCat = function (device) {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
    ...
    ApicallProvider.prototype.addNewBrand = function (device) {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
    ...
    ApicallProvider.prototype.getUser = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
    ...
    ApicallProvider.prototype.livemap = function (device) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.get(apiUrl + 'livemap?d=' + device, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.getreports = function (device, rf, rt) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.get(apiUrl + 'reports?d=' + device + "&rf=" + rf + "&rt=" + rt, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.getnotifications = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.get(apiUrl + 'notifications?accountID=' + localStorage.getItem('accountID'), { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.setnotifications = function (data) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'setnotifications', { noti: data }, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.deletenotification = function (data) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'deletenotifications', { noti: data }, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.deletedevice = function (id) {
        console.log(id);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'deletedevice', { id: id }, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.editdevice = function (newData) {
        console.log(newData);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'editdevice', { newData: newData }, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.changeuserstatus = function (id) {
        console.log(id);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'changeuserstatus', { id: id }, { headers: headers }).map(function (res) { return res.json(); });
    };
    ApicallProvider.prototype.resetdevice = function (id) {
        console.log(id);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization', localStorage.getItem('auth_app_token'));
        return this.http.post(apiUrl + 'resetdevice', { id: id }, { headers: headers }).map(function (res) { return res.json(); });
    };
    return ApicallProvider;
}());
ApicallProvider = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
